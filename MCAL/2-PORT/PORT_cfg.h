...
#define PORTA_PIN1_INTIAL_VAL			FLOATING
#define PORTA_PIN2_INTIAL_VAL			FLOATING
#define PORTA_PIN3_INTIAL_VAL			FLOATING
#define PORTA_PIN4_INTIAL_VAL			FLOATING
#define PORTA_PIN5_INTIAL_VAL			FLOATING
#define PORTA_PIN6_INTIAL_VAL			FLOATING
...
#define PORTB_PIN4_INTIAL_VAL			FLOATING
#define PORTB_PIN5_INTIAL_VAL			FLOATING
#define PORTB_PIN6_INTIAL_VAL			FLOATING
#define PORTB_PIN7_INTIAL_VAL			FLOATING

#define PORTC_PIN0_INTIAL_VAL			HIGH
#define PORTC_PIN1_INTIAL_VAL			HIGH
#define PORTC_PIN2_INTIAL_VAL			HIGH
#define PORTC_PIN3_INTIAL_VAL			HIGH
...
#define PORTD_PIN2_INTIAL_VAL			FLOATING
#define PORTD_PIN3_INTIAL_VAL			FLOATING
#define PORTD_PIN4_INTIAL_VAL			FLOATING
#define PORTD_PIN5_INTIAL_VAL			FLOATING
